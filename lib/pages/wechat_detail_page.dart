...
class WechatDetailPage extends StatefulWidget {
  const WechatDetailPage({super.key});

  @override
  State<WechatDetailPage> createState() => _WechatDetailPageState();
}

class _WechatDetailPageState extends State<WechatDetailPage> {
  ...
  Future<void> _loadTransactions() async {
    ...
    final wechatTxs = txs.where((t) => t.account == 'WeChat').toList();
    
    setState(() {
      _transactions = wechatTxs;
      _balance = wechatTxs.fold(0.0, (sum, tx) => sum + tx.amount);
    });
  }
  ...
  Widget _buildWechatCard() {
    return Container(
      ...
      child: Stack(
        children: [
          // Faded large icon in the background
          Positioned.fill(
            child: Align(
              alignment: Alignment.centerRight,
              child: Icon(
                FontAwesomeIcons.weixin, // WeChat icon
                size: 200, // Very large
                color: Colors.white.withOpacity(0.1), // Faded
              ),
            ),
          ),
          Column(
            ...
            children: [
              // Top section (Logo and Card Number)
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  // WeChat Logo at top right
                  Column(
                    children: [
                      const Text(
                        'WeChat',
                      ...
                      Icon(FontAwesomeIcons.weixin, color: Colors.white, size: 24), // Changed to white for contrast
                    ],
                  ),
                ],
              ),
              ...
              const Text(
                'CURRENT BALANCE',
                style: TextStyle(color: Colors.white70, fontSize: 12), // Adjusted text color
              ),
